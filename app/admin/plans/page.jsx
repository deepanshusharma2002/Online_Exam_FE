...
import PlanList from "@/src/components/Jobs/PlanList";
import CreatePaln from "@/src/components/Jobs/CreatePaln";
...
export default function PlainDashboard() {
    ...
    return (
        <div className="dashboard-container">
            ...
            {isViewForm ? <CreatePaln editData={editData} handleCloseForm={handleCloseForm} /> : <PlanList handleEditData={handleEditData} handleOpenForm={handleOpenForm} />}
